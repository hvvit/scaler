...
var rootCmd = &cobra.Command{
	Use:   "scaler",
	Short: "An application scaler for rest upstream server",
	Long: `A scaler is a tool to scale the upstream server based on the load of the server.
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.scaler.yaml)")
